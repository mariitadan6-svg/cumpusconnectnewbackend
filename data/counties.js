...
const kenyaUniversities = {
  ...
  "Mama Ngina University College": ["Kiambu"],
  "Kenyatta University Mama Ngina University College": ["Kiambu"],
  ...
  "St. Paul's University - Machakos Campus": ["Machakos"],
  "Africa International University": ["Nairobi"],
  "Kenya Methodist University - Nairobi Campus": ["Nairobi"],
  "KCA University - Kitengela Campus": ["Kitengela"],
  "Mount Kenya University - Nakuru Campus": ["Nakuru"],
  "Mount Kenya University - Mombasa Campus": ["Mombasa"],
  "Mount Kenya University - Kisumu Campus": ["Kisumu"],
  "Mount Kenya University - Eldoret Campus": ["Eldoret"],
  "Zetech University - Ruiru Campus": ["Ruiru"],
  ...
  "KMTC Busia": ["Busia"],
  "KMTC Chwele": ["Chwele"],
  "KMTC Gatundu": ["Gatundu"],
  "KMTC Imenti": ["Meru"],
  "KMTC Isiolo": ["Isiolo"],
  "KMTC Kabarnet": ["Kabarnet"],
  "KMTC Kajiado": ["Kajiado"],
  "KMTC Kangundo": ["Kangundo"],
  "KMTC Karen": ["Karen"],
  "KMTC Karuri": ["Karuri"],
  "KMTC Kilifi": ["Kilifi"],
  "KMTC Kitale": ["Kitale"],
  "KMTC Kuria": ["Kehancha"],
  "KMTC Lamu": ["Lamu"],
  "KMTC Loitoktok": ["Loitoktok"],
  "KMTC Macharia": ["Thika"],
  "KMTC Makindu": ["Makindu"],
  "KMTC Makueni": ["Wote"],
  "KMTC Mandera": ["Mandera"],
  "KMTC Marsabit": ["Marsabit"],
  "KMTC Mathare": ["Nairobi"],
  "KMTC Migori": ["Migori"],
  "KMTC Molo": ["Molo"],
  "KMTC Msambweni": ["Msambweni"],
  "KMTC Mwingi": ["Mwingi"],
  "KMTC Naivasha": ["Naivasha"],
  "KMTC Narok": ["Narok"],
  "KMTC Nyahururu": ["Nyahururu"],
  "KMTC Port Reitz": ["Mombasa"],
  "KMTC Rachuonyo": ["Oyugis"],
  "KMTC Samburu": ["Maralal"],
  "KMTC Sigowet": ["Sigowet"],
  "KMTC Teso": ["Amagoro"],
  "KMTC Ugenya": ["Ugunja"],
  "KMTC Vihiga": ["Vihiga"],
  "KMTC Voi": ["Voi"],
  ...
  "Nyamira Teachers Training College": ["Nyamira"],
  "Chuka Teachers Training College": ["Chuka"],
  "Kisii Teachers Training College": ["Kisii"],
  "Mombasa Teachers Training College": ["Mombasa"],
  ...
  "Zetech College": ["Ruiru"],
  "Kisii College of Accountancy": ["Kisii"],
  "Eldoret Aviation College": ["Eldoret"],
  "Summit College of Applied Sciences": ["Nakuru"]
};
